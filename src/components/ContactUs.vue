<template>
    <div class="mt-24 max-w-screen-sm mx-auto">
        <h1 class="text-2xl font-semibold text-gray-800 uppercase text-center">Contact Us</h1>
        <form>
            <div class="mb-6">
            ...
            <button type="submit" class="text-white bg-blue-400 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center uppercase">Submit</button>
        </form>
    </div>
</template>